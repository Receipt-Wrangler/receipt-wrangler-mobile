...
class PagedRequestFieldValue {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PagedRequestFieldValue &&
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PagedRequestFieldValue[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PagedRequestFieldValue[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PagedRequestFieldValue> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<PagedRequestFieldValue>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PagedRequestFieldValue>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PagedRequestFieldValue.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
