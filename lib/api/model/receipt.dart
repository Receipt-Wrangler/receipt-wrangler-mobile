...
class Receipt {
  ...
  bool operator ==(Object other) => identical(this, other) || other is Receipt &&
    ...
    other.id == id &&
    _deepEquality.equals(other.imageFiles, imageFiles) &&
    other.name == name &&
    other.paidByUserId == paidByUserId &&
    _deepEquality.equals(other.receiptItems, receiptItems) &&
  ...
  @override
  String toString() => 'Receipt[amount=$amount, categories=$categories, comments=$comments, createdAt=$createdAt, createdBy=$createdBy, date=$date, groupId=$groupId, id=$id, imageFiles=$imageFiles, name=$name, paidByUserId=$paidByUserId, receiptItems=$receiptItems, resolvedDate=$resolvedDate, status=$status, tags=$tags, updatedAt=$updatedAt, createdByString=$createdByString]';
  ...
  static Receipt? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Receipt(
        ...
        imageFiles: FileData.listFromJson(json[r'imageFiles']),
