...
const ionicGlobal = require('./ionic-global-ba1bd66f.js');
...
const index$2 = require('./index-2a6bca71.js');
    ...
    componentDidLoad() {
        {
            rIC(async () => {
                ...
                if (ionicGlobal.config.getBoolean('statusTap', isHybrid)) {
                    Promise.resolve().then(function () { return require('./status-tap-1958acfd.js'); }).then((module) => module.startStatusTap());
                }
