...
describe('ionic-conference-app', () => {
    it('should match conference-app routing', () => {
        ...
        expect(getRoutePath([{ id: 'page-tabs' }, { id: 'TAB-SPEAKER' }, { id: 'page-speaker-list' }], routes)).toEqual('/speaker');
