...
describe('getClassList()', () => {
    ...
    it('should pass array', () => {
        ...
        expect(getClassList(['class   ', null, undefined, '', '   class-event', '  ', '  THEME-ios-bar-button  '])).toEqual(['class', 'class-event', 'THEME-ios-bar-button']);
    });
});
describe('getClassMap()', () => {
    ...
    it('should pass array', () => {
        ...
        expect(getClassMap(['class   ', null, undefined, '', '   class-event', '  ', '  THEME-ios-bar-button  '])).toEqual({
            class: true,
            'class-event': true,
            'THEME-ios-bar-button': true,
        });
