const _parenSuffix = ")(?:\\(((?:\\([^)(]*\\)|[^)(]*)+?)\\))?([^,{]*)", _cssColonHostRe = new RegExp("(-shadowcsshost" + _parenSuffix, "gim"), _cssColonHostContextRe = new RegExp("(-shadowcsscontext" + _parenSuffix, "gim"), _cssColonSlottedRe = new RegExp("(-shadowcssslotted" + _parenSuffix, "gim"), _polyfillHostNoCombinatorRe = /-shadowcsshost-no-combinator([^\s]*)/, _shadowDOMSelectorsRe = [ /::shadow/g, /::content/g ], _polyfillHostRe = /-shadowcsshost/gim, createSupportsRuleRe = e => new RegExp(`((?<!(^@supports(.*)))|(?<={.*))(${e}\\b)`, "gim"), _colonSlottedRe = createSupportsRuleRe("::slotted"), _colonHostRe = createSupportsRuleRe(":host"), _colonHostContextRe = createSupportsRuleRe(":host-context"), _commentRe = /\/\*\s*[\s\S]*?\*\//g, _commentWithHashRe = /\/\*\s*#\s*source(Mapping)?URL=[\s\S]+?\*\//g, _ruleRe = /(\s*)([^;\{\}]+?)(\s*)((?:{%BLOCK%}?\s*;?)|(?:\s*;))/g, _curlyRe = /([{}])/g, _selectorPartsRe = /(^.*?[^\\])??((:+)(.*)|$)/, processRules = (e, t) => {
 ...
 return o.escapedString.replace(_ruleRe, ((...e) => {
  const c = e[2];
  let r = "", l = e[4], n = "";
  l && l.startsWith("{%BLOCK%") && (r = o.blocks[s++], l = l.substring(8), n = "{");
  const a = t({
   selector: c,
   content: r
  });
 ...
 for (let e = 0; e < t.length; e++) {
  const l = t[e];
  "}" === l && c--, c > 0 ? r.push(l) : (r.length > 0 && (s.push(r.join("")), o.push("%BLOCK%"), 
  r = []), o.push(l)), "{" === l && c++;
 }
 ...
 new RegExp("^(" + e + ")([>\\s~+[.,{:][\\s\\S]*)?$", "m")))(t).test(e))(e, t) ? ((e, t, o) => {
  ...
  for (;null !== (l = p.exec(e)); ) {
   const t = l[1], o = e.slice(a, l.index).trim();
   i = i || o.indexOf("-shadowcsshost-no-combinator") > -1, n += `${i ? c(o) : o} ${t} `, 
   a = p.lastIndex;
  }
  const h = e.substring(a);
  return i = i || h.indexOf("-shadowcsshost-no-combinator") > -1, n += i ? c(h) : h, 
  u = r.placeholders, n.replace(/__ph-(\d+)__/g, ((e, t) => u[+t]));
  var u;
...
})), replaceShadowCssHost = (e, t) => e.replace(/-shadowcsshost-no-combinator/g, `.${t}`), scopeCss = (e, t, o) => {
 const s = t + "-h", c = t + "-s", r = e.match(_commentWithHashRe) || [];
 e = e.replace(_commentRe, "");
 const l = [];
 if (o) {
  const t = e => {
   const t = `/*!@___${l.length}___*/`, o = `/*!@${e.selector}*/`;
   return l.push({
    placeholder: t,
    comment: o
 ...
 const n = ((e, t, o, s, c) => {
  const r = ((e, t) => {
   ...
   return e = e.replace(_cssColonSlottedRe, ((...e) => {
    if (e[2]) {
     ...
     const n = (l + r).trim(), a = `${l.trimEnd()}${r.trim()}`.trim();
     if (n !== a) {
      const e = `${a}, ${n}`;
      s.push({
       orgSelector: n,
  ...
  })(e = (e => convertColonRule(e, _cssColonHostContextRe, colonHostContextPartReplacer))(e = (e => convertColonRule(e, _cssColonHostRe, colonHostPartReplacer))(e = (e => e.replace(_colonHostContextRe, "$1-shadowcsscontext").replace(_colonHostRe, "$1-shadowcsshost").replace(_colonSlottedRe, "$1-shadowcssslotted"))(e))), s);
  return e = (e => _shadowDOMSelectorsRe.reduce(((e, t) => e.replace(t, " ")), e))(e = r.cssText), 
  t && (e = scopeSelectors(e, t, o, s)), {
   cssText: (e = (e = replaceShadowCssHost(e, o)).replace(/>\s*\*\s+([^{, ]+)/gm, " $1 ")).trim(),
 ...
 return e = [ n.cssText, ...r ].join("\n"), o && l.forEach((({placeholder: t, comment: o}) => {
  e = e.replace(t, o);
 })), n.slottedSelectors.forEach((t => {
  const o = new RegExp(t.orgSelector.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), "g");
