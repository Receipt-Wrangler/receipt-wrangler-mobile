...
export declare namespace UpdateGroupSettingsCommand {
    type EmailDefaultReceiptStatusEnum = 'OPEN' | 'NEEDS_ATTENTION' | 'RESOLVED' | 'DRAFT';
    const EmailDefaultReceiptStatusEnum: {
        OPEN: EmailDefaultReceiptStatusEnum;
        NEEDSATTENTION: EmailDefaultReceiptStatusEnum;
        RESOLVED: EmailDefaultReceiptStatusEnum;
        DRAFT: EmailDefaultReceiptStatusEnum;
    };
}
